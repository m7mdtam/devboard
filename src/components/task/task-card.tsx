...
export function TaskCard(props: TaskCardProps) {
  ...
  const priorityVariant = props.task.priority === 'low' ? 'ghost' : props.task.priority === 'medium' ? 'secondary' : 'destructive'
      ...
      <div className="relative z-10 flex flex-col gap-3">
        <div className="flex items-start justify-between gap-2">
          ...
          <button
            ...
            className="flex-shrink-0 p-1 rounded text-text-secondary hover:text-destructive hover:bg-destructive/10 opacity-0 group-hover:opacity-100 transition-all"
            type="button"
