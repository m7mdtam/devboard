    ...
    >
      ...
      >
        <ElectricBorder
          ...
          borderRadius={8}
        >
          <div className="group relative p-3 sm:p-4 rounded-lg bg-surface hover:shadow-md transition-all duration-200 cursor-grab active:cursor-grabbing">
            ...
            <div className="relative z-10 flex flex-col gap-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <Button
                  ...
                  className="shrink-0 text-text-secondary hover:text-destructive hover:bg-destructive/10 opacity-0 group-hover:opacity-100 transition-all"
                  type="button"
